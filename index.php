...
'Connection: keep-alive',
'User-Agent: Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 5.1; WOW64; Trident/5.0)',
'Accept: */*',
...
curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 5.1; WOW64; Trident/5.0)"); 
...
$header[] = "User-Agent: Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 5.1; WOW64; Trident/5.0)"; 
$header[] = "Accept: */*"; 
	...
	private function request($path,$account = 0,$post = 0,$datas = 0,$returnHeaders = 0){
	  ...
	  if($account == 0){
	  	curl_setopt($ch, CURLOPT_HTTPHEADER, array(
		     ...
		     'user-agent: Instagram 141.0.0.17.118 Android (29/10; 450dpi; 1080x2192; samsung; SM-G986U; y2q; qcom; en_US; 213368022)',
		     'host: i.instagram.com',
		     'X-CSRFToken: missing',
		     'X-Instagram-AJAX: 1',
